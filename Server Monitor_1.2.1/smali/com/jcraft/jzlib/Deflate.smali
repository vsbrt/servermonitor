...
.method _tr_flush_block(IIZ)V
    ...
    iget v3, p0, Lcom/jcraft/jzlib/Deflate;->level:I

    if-lez v3, :cond_3

    .line 857
    iget-byte v3, p0, Lcom/jcraft/jzlib/Deflate;->data_type:B
    ...
    invoke-virtual {v3, p0}, Lcom/jcraft/jzlib/Tree;->build_tree(Lcom/jcraft/jzlib/Deflate;)V

    .line 862
    iget-object v3, p0, Lcom/jcraft/jzlib/Deflate;->d_desc:Lcom/jcraft/jzlib/Tree;
    ...
    .line 872
    iget v3, p0, Lcom/jcraft/jzlib/Deflate;->opt_len:I
...
.method _tr_stored_block(IIZ)V
    ...
    .line 842
    invoke-virtual {p0, p1, p2, v2}, Lcom/jcraft/jzlib/Deflate;->copy_block(IIZ)V
...
.method _tr_tally(II)Z
    ...
    .line 627
    iget-object v3, p0, Lcom/jcraft/jzlib/Deflate;->pending_buf:[B

    iget v4, p0, Lcom/jcraft/jzlib/Deflate;->d_buf:I
    ...
    iget v4, p0, Lcom/jcraft/jzlib/Deflate;->l_buf:I
    ...
    iget v3, p0, Lcom/jcraft/jzlib/Deflate;->last_lit:I

    add-int/lit8 v3, v3, 0x1

    iput v3, p0, Lcom/jcraft/jzlib/Deflate;->last_lit:I
    ...
    iget-object v5, p0, Lcom/jcraft/jzlib/Deflate;->dyn_dtree:[S
    ...
    sget-object v9, Lcom/jcraft/jzlib/Tree;->extra_dbits:[I
    ...
    iput v3, p0, Lcom/jcraft/jzlib/Deflate;->matches:I
    ...
    sget-object v4, Lcom/jcraft/jzlib/Tree;->_length_code:[B
    ...
    .line 641
    iget-object v3, p0, Lcom/jcraft/jzlib/Deflate;->dyn_dtree:[S
    ...
    iget v4, p0, Lcom/jcraft/jzlib/Deflate;->lit_bufsize:I
...
.method deflate_fast(I)I
    ...
    invoke-virtual {p0, v2, v3}, Lcom/jcraft/jzlib/Deflate;->_tr_tally(II)Z
    ...
    iget v3, p0, Lcom/jcraft/jzlib/Deflate;->max_lazy_match:I
    ...
    .line 1091
    invoke-virtual {p0, v6}, Lcom/jcraft/jzlib/Deflate;->flush_block_only(Z)V
    ...
    invoke-virtual {p0, v6, v2}, Lcom/jcraft/jzlib/Deflate;->_tr_tally(II)Z
...
.method deflate_slow(I)I
    ...
    invoke-virtual {p0, v7, v3}, Lcom/jcraft/jzlib/Deflate;->_tr_tally(II)Z

    move-result v0

    .line 1224
    .local v0, "bflush":Z
    iput v7, p0, Lcom/jcraft/jzlib/Deflate;->match_available:I
    ...
    .line 1140
    iput v9, p0, Lcom/jcraft/jzlib/Deflate;->match_length:I
    ...
    iget v4, p0, Lcom/jcraft/jzlib/Deflate;->max_lazy_match:I
    ...
    invoke-virtual {p0, v3, v4}, Lcom/jcraft/jzlib/Deflate;->_tr_tally(II)Z
    ...
    .line 1195
    invoke-virtual {p0, v7}, Lcom/jcraft/jzlib/Deflate;->flush_block_only(Z)V
    ...
    .end local v0    # "bflush":Z
    :cond_c
    iput v8, p0, Lcom/jcraft/jzlib/Deflate;->match_available:I
...
.method deflate_stored(I)I
    ...
    .line 807
    iput v5, p0, Lcom/jcraft/jzlib/Deflate;->lookahead:I
...
.method fill_window()V
    ...
    invoke-virtual {v4, v5, v6, v1}, Lcom/jcraft/jzlib/ZStream;->read_buf([BII)I
...
.method send_all_trees(III)V
    ...
    invoke-virtual {p0, v1, v4}, Lcom/jcraft/jzlib/Deflate;->send_bits(II)V
...
.method send_tree([SI)V
    ...
    invoke-virtual {p0, v7, v9}, Lcom/jcraft/jzlib/Deflate;->send_bits(II)V
